...
export function PhotoCell({ photo, index, showDate = true }: PhotoCellProps) {
  const src = photo.imageData || getSafeUrl(photo.url || "");
  ...
  return (
    ...
    >
      ...
      <div className="tl-photo-caption">
        {photo.altText && photo.altText !== photo.url && !['Photo', 'Unknown Photo', 'Uploaded from Android App'].includes(photo.altText)
          ? photo.altText
          : photo.locationName
          ? photo.locationName
